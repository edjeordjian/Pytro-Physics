...
from constants.tab_constants import RESISTIVITY_TAB_NAME, RESISTIVITY_CURVE_NAME, VSHALE_LBL
...
from services.vshale_service import get_resistivity_vshale
...
class ResistivityTab(QWidgetWithWell):
    def __init__(self):
        super().__init__("Resistividad")
    ...
    def initUI(self):
        ...
        self.curveLbl = QLabel("Curva Resistividad: ")
        ...
        for i in range(groupAmount):
            group = {
                ...
                "Min Curve Label": QLabel("Resisitividad Shale: "),
                "Min Curve QLE": QLineEdit(self),
                "Max Curve Label": QLabel("Resisitividad Max: "),
            ...
            group["Grid Layout"].addWidget(group["Line"], 6, 2, alignment=Qt.AlignmentFlag.AlignLeft)
    ...
    def preview(self):
        ...
        config_curve = {
            ...
            'track_name': 'Resistividad',
            'curve_name': RESISTIVITY_CURVE_NAME,
        ...
        config_vshale = {
            'tab_name': self.tab_name,
            'track_name': f'V Shale ({self.tab_name})',
            'curve_name': RESISTIVITY_TAB_NAME,
    ...
    def get_vshale(self):
        ...
        for group in self.groups:
            if group["Min Depth QLE"].isEnabled():
                ...
                vshale_resistivity_groups.append(get_resistivity_vshale(self.well.wellModel.get_partial_ranged_df_curve(self.selectedCurve,
        ...
        return reduce(self.well.wellModel.combine_curves, vshale_resistivity_groups)
