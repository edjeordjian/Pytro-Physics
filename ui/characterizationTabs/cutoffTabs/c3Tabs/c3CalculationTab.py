...
from constants.tab_constants import CUTOFF_C3_TITLE
...
class C3CalculationTab(QWidgetStandAlone):
    def __init__(self, tab_name):
        ...
        self.numeric_inputs.extend([self.cutoffValueQle, self.thcValueQle,
                                    self.c1CutoffQle, self.c2CutoffQle,
        ...
        self.add_serializable_attributes(self.curve_selectors + [self.depthFullLasRb, self.depthCustomRb,
             self.customMinDepthQle, self.customMaxDepthQle, self.c3CutoffLineStyleCbo,  self.c3CutoffColorCbo,
             ...
             self.c2CutoffQle, self.c2CutoffQle,  self.cutoffValueQle, self.cutoffValueRb,
    ...
    def initUI(self):
        ...
        self.c3Layout = QHBoxLayout()
        self.c3Layout.addWidget(self.c3Lbl)
        self.c3Layout.addWidget(self.c3Cbo)
        self.c3Layout.addWidget(QLabel(""))
        self.gridLayout.addLayout(self.c3Layout, row, 0, 1, 2)
        ...
        self.c3CutoffStyleLbl = QLabel("Color y Tipo de Linea: ")
        self.c3CutoffColorCbo = color_combo_box()
        self.c3CutoffColorCbo.setCurrentIndex(0)
        self.c3CutoffLineStyleCbo = line_combo_box()
        self.c3CutoffLineStyleCbo.setCurrentIndex(0)

        self.c3CutoffStyleLayout = QHBoxLayout()
        self.c3CutoffStyleLayout.addWidget(self.c3CutoffStyleLbl)
        self.c3CutoffStyleLayout.addWidget(self.c3CutoffColorCbo)
        self.c3CutoffStyleLayout.addWidget(self.c3CutoffLineStyleCbo)

        self.gridLayout.addLayout(self.c3CutoffStyleLayout, row, 0, 1, 2)
    ...
    def preview(self):
        ...
        x_title = self.well \
            .wellModel \
            .get_label_for(self.c3Cbo
                           .currentText())

        config = {
            'title': CUTOFF_C3_TITLE,
            ...
            'line_groups': [{
                    ...
                    'color': self.c3CutoffColorCbo.currentText(),
                    'line': self.c3CutoffLineStyleCbo.currentText()
                },
                {
    ...
    def saveCurve(self):
        ...
        if str(self.nameQle.text()) == "":
            AlertWindow("El nombre de la curva no puede estar vacio")
            return
