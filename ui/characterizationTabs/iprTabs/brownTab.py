...
from services.ipr_service import (get_brown, get_h_from_curve, get_k_from_curve)
from services.tools.string_service import is_number


class BrownTab(QWidgetStandAlone):
    def __init__(self):
        ...
        self.add_serializable_attributes(self.curve_selectors + [self.depthFullLasRb, self.depthCustomRb,
              ...
              self.bubblePressureQle, self.distanceUnitMetersRb, self.distanceUnitFeetRb])
