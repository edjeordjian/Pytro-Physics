...
from constants.permeability_constants import (CONSTANT_LBL, DEFAULT_TIXIER_CONSTANT, INVALID_CONSTANT, K_LBL, MD_LBL)

from constants.porosity_constants import EFFECTIVE_POROSITY_CURVE

from constants.swirr_constants import SWIRR_TAB_NAME

from services.permeability_service import get_tixier_permeability
...
class PermeabilityTixier(QWidgetWithSections):
    def __init__(self):
        super().__init__(permeability_constants.PERMEABILITY_TIXIER)

        self.init_ui(permeability_constants.PERMEABILITY_TIXIER)
    ...
    def curves_section(self):
        ...
        self.constant_textbox = QLineEdit(DEFAULT_TIXIER_CONSTANT)
    ...
    def preview(self):
        ...
        self.curve_to_save = get_tixier_permeability(porosity,
                                                     swirr,
                                                     float(constant))
        ...
        base_dict = {
            'tab_name': permeability_constants.PERMEABILITY_TIXIER,

            'track_name': permeability_constants.TIXIER_TRACK_NAME,
        ...
        self.add_curve_with_y_label({** base_dict,
                                     ** {
                                      ...
                                      'curve_name': permeability_constants.TIXIER_TRACK_NAME,
        ...
        graphic_window.draw_tracks(permeability_constants.PERMEABILITY_TIXIER)
