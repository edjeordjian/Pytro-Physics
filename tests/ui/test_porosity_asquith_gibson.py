...
from constants.porosity_constants import TOTAL_POROSITY_BY_AG_NAME
...
def test_porosity_asquith_gibson_view(qtbot):
    ...
    load_view_to_window(qtbot, graphic_window, current_path, "porosity_asquith_gibson.view")

    assert 0.1457 == graphic_window.curve_tracks[0] \
               .configs[TOTAL_POROSITY_BY_AG_NAME]["x_axis"][-1]
